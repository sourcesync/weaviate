...
DATASET="/mnt/nas1/fvs_benchmark_datasets/deep-250M.npy"
...
GROUNDTRUTH="/mnt/nas1/fvs_benchmark_datasets/deep-250M-gt-1000.npy"
...
function run_benchmark() {
    BITS=$1
    BASE="benchmarks-deep250M-q1000-qbq-clusters-$BITS"
