...
DTDIR="results/$DT"
mkdir -p $DTDIR
OUTPUT="$DTDIR/benchmarks-deep5M-q100-$DT.csv"
...
#
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 768 2>&1 | tee "$DTDIR/5M_100_768b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 768 2>&1 | tee "$DTDIR/5M_100_768b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 768 2>&1 | tee "$DTDIR/5M_100_768b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 512 2>&1 | tee "$DTDIR/5M_100_512b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 512 2>&1 | tee "$DTDIR/5M_100_512b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 512 2>&1 | tee "$DTDIR/5M_100_512b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 256 2>&1 | tee "$DTDIR/5M_100_256b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 256 2>&1 | tee "$DTDIR/5M_100_256b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 256 2>&1 | tee "$DTDIR/5M_100_256b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 128 2>&1 | tee "$DTDIR/5M_100_128b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 128 2>&1 | tee "$DTDIR/5M_100_128b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 128 2>&1 | tee "$DTDIR/5M_100_128b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 64  2>&1 | tee "$DTDIR/5M_100_64b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 64  2>&1 | tee "$DTDIR/5M_100_64b_$DT_$(date +%s).txt"
python -u gemini_fvs.py -a "$ALLOCATION_ID" -d "$DATASET" -q "$QUERIES" -g "$GROUNDTRUTH"  -o "$OUTPUT" --b 64  2>&1 | tee "$DTDIR/5M_100_64b_$DT_$(date +%s).txt"
