...
func (o *ObjectsClassDeleteURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on ObjectsClassDeleteURL")
	}
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsClassDeleteURL")
	}
...
func (o *ObjectsClassDeleteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsClassDeleteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsClassDeleteURL")
	}
