...
// ObjectsReferencesCreateParams contains all the bound params for the objects references create operation
...
func (o *ObjectsReferencesCreateParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ObjectsReferencesCreateParams) validateID(formats strfmt.Registry) error {
...
func (o *ObjectsReferencesCreateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
