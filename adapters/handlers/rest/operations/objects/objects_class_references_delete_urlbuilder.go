...
func (o *ObjectsClassReferencesDeleteURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on ObjectsClassReferencesDeleteURL")
	}
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsClassReferencesDeleteURL")
	}
	...
	if propertyName != "" {
		...
		return nil, errors.New("propertyName is required on ObjectsClassReferencesDeleteURL")
	}
...
func (o *ObjectsClassReferencesDeleteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsClassReferencesDeleteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsClassReferencesDeleteURL")
	}
