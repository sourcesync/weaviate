...
// SchemaObjectsDeleteParams contains all the bound params for the schema objects delete operation
...
func (o *SchemaObjectsDeleteParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
