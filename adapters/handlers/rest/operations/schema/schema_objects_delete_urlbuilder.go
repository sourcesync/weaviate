...
func (o *SchemaObjectsDeleteURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on SchemaObjectsDeleteURL")
	}
...
func (o *SchemaObjectsDeleteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SchemaObjectsDeleteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SchemaObjectsDeleteURL")
	}
